  ...
  return (
    <div className="body-bg min-h-screen flex flex-col items-center pt-10">
      ...
      <header className="relative z-10 mt-0">
        <img src="/kd5_white.svg" alt="KD-Lab Logo" className="mx-auto w-40" />
      </header>
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            <div className="mb-6 pt-3 rounded bg-gray-200">
              ...
              <input
                ...
                className="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-200 focus:border-purple-600 transition duration-500 px-3 pb-3"
                placeholder="Enter your login name"
              />
            </div>

            <div className="mb-6 pt-3 rounded bg-gray-00">
